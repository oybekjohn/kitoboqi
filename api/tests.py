...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.user.save()
        self.client.login(username="jakhongir", password="somepass")  # permission_classes uchun login qildi

    def test_book_review_detail(self):
        book = Book.objects.create(title="Book1", describtion="Description1", isbn="123121")
        ...
        self.assertEqual(response.data['book']['describtion'], 'Description1')
    ...
    def test_book_review_list(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data['results']), 2)  # paginatsiyada qilganda resultda 2ta review qaytganini tekshiradi
